...
/* On teste les champs entrés et s'il y a des erreurs on remplit $_SESSION["error"]  */
	...
	$_SESSION["error"] .= (empty($bact_host)|| preg_match("/[^a-zA-Z0-9- _:.']/",$bact_host)) ? "Bacterial host is required.</br>" : "";
...
// Connexion à la  base ISsubmit
	    // $cnx=connexion("192.168.12.42","issubmit","ISsubmit","My;14U#GvACsP9*,");
