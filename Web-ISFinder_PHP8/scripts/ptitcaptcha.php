...
class PtitCaptchaHelper
{
	...
	{
		$captcha_entre = htmlentities($_POST['ptitcaptcha_entry']);
		$captcha_key = htmlentities($_POST['ptitcaptcha_key']);
		if(	!empty($captcha_entre) && 
			$captcha_entre == PtitCaptchaHelper::_getDisplayText($captcha_key))
		{
			return true;
		}
		return false;
