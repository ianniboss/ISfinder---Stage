...
//erreur formulaire soumission (champ vide)
...
// Remplacement de mysql_result qui n'a pas d'equivalent en php7
...
// La variable est une séquence proteique
...
/*      global $cnx;
    if (!$cnx){
//      connexion("astun","isadmin","ISfinder");
        connexion("isfinder");
    }
*/
...
// L'élément transposable ID_ET existe dans une table
...
// Pour afficher les accents sur page html sans perdre les balises html
...
// Bact_origin existe déjà dans la table nom_type (base ISfinder)
...
// Submiter existe déjà dans la table submiters
...
// Envoie du mail après attribution de nom
