    ...
    if (isset($_SESSION['base'])) {
        foreach ($_SESSION['base'] as $base_select) {
            ...
            if ($nombre > 0) {
                ...
                */
                $nom = sort_link('Name', 'ET_name', $champrecherche, $champ);
                $family = sort_link('Family', $famille, $champrecherche, $champ);
                ...
                if ($bdd == "isfinder") {
                    ...
                    affiche_resultSub($cnx, $result, $fond_base, $bdd);
                }
                print "</table>";
            } else {                                    /* Pas de rsultat */
