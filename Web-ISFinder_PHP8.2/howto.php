...
<!--		<div class="ecran">contenu de mon &eacutecran</div> -->
 ...
 <fieldset>
   <div>
   <h2>Citations:</h2>
   <p><strong>For ISfinder please cite</strong>: Siguier P. et al. (2006) ISfinder: the reference centre for bacterial  insertion sequences. Nucleic Acids Res. 34: D32-D36 (<a href="http://www.ncbi.nlm.nih.gov/pubmed/16381877" target="_blank">link pubmed</a>) and the  database URL (http://www-is.biotoul.fr).<br>
   </p>
   <p><strong>For ISbrowser please cite:</strong> Kichenaradja P. et   al. (2010) ISbrowser: an  extension of ISfinder for visualizing   insertion sequences in prokaryotic  genomes. Nucleic Acids Res. 38:   D62-D68 (<a href="http://www.ncbi.nlm.nih.gov/pubmed/19906702" target="_blank">link pubmed</a>).</p>
   <p><strong>For ISsaga please cite:</strong> Varani A. et al. (2011) ISsaga: an ensemble of  web-based methods for high throughput   identification and semi-automatic  annotation of insertion sequences in   prokaryotic genomes, Genome Biology 2011, 12:R30 (<a href="https://pubmed.ncbi.nlm.nih.gov/21443786/" target="_blank">link pubmed</a>).</p>
   <p>&nbsp;</p>
   </div>
   <div>
